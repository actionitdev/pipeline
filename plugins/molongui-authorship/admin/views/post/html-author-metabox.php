...
<div class="molongui-metabox">
    ...
    <?php if ( !empty( $add_new ) ) : ?>
        <div class="m-field">
            <a id="molongui-add-guest-link" class="molongui-tip" data-tip="<?php _e( "You can quick-add a new guest author now. Later on you will be able to fully edit all profile info through Guest Authors menu item.", 'molongui-authorship' ); ?>">
                <?php echo $add_new; ?>
            </a>
        </div>
