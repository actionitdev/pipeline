    ...
    <table class="form-table" role="presentation">
        ...
        <?php if ( molongui_authorship_is_feature_enabled( 'box' ) ) : ?>
            <tr class="user-description-wrap">
                ...
                <td>
                    <textarea name="molongui_author_short_bio" id="molongui_author_short_bio" rows="3" cols="30" <?php echo ( MOLONGUI_AUTHORSHIP_IS_PRO ? '' : 'disabled="disabled"' ); ?>><?php echo esc_attr( get_the_author_meta( 'molongui_author_short_bio', $user->ID ) ); ?></textarea>
