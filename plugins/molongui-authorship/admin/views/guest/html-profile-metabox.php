                ...
                <div class="m-flex-content">
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_first_name">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "Author's name", 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_last_name">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "Author's last name", 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_display_name">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "This is a phrase that refers to the author's name. Most of the time, it is the name of the author, but you can write in whatever you wish. This will be shown as author name.", 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_mail">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "Author's e-mail address. Used to retrieve author's Gravatar if it exists and no local avatar is uploaded. This field is not displayed in the front-end unless configured so. See 'Author box settings' on this same page.", 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_web">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "URL to the author's website, blog or profile page. Leave blank to prevent this field to be displayed in the front-end.", 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_phone"><?php _e( 'Phone', 'molongui-authorship' ); ?>
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( "Author's telephone number. This field is not displayed in the front-end unless configured so. See 'Author box settings' on this same page.", 'molongui-authorship' ); ?>"></i>
                        </label>
                ...
                <div class="m-flex-content">
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_job">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( 'Name used to describe what the author does for a business or another enterprise. It will be displayed in the author box, just below the author name. Leave blank to prevent this field to be displayed in the front-end.', 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_company">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( 'The name of the company the author works for. It will be displayed in the author box, just below the author name. Leave blank to prevent this field to be displayed in the front-end.', 'molongui-authorship' ); ?>"></i>
                        </label>
                    ...
                    <div class="m-field">
                        <label class="m-title" for="_molongui_guest_author_company_link">
                            ...
                            <i class="tip m-a-icon-tip m-help-tip" data-tip="<?php _e( 'URL the company name will link to. Leave blank to disable link feature.', 'molongui-authorship' ); ?>"></i>
                        </label>
