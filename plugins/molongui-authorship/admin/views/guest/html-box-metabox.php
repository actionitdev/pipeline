...
<div class="molongui-metabox">
    ...
    <div class="m-field">
        ...
        <p class="m-description">
            ...
            <?php if ( !MOLONGUI_AUTHORSHIP_IS_PRO ) echo ' <i>'.sprintf( __( 'Disabled options are only available in the %sPremium version%s of the plugin.', 'molongui-authorship' ), '<a href="'.MOLONGUI_AUTHORSHIP_WEB.'">', '</a>' ).'</i>'; ?>
        </p>
        <select name="_molongui_guest_author_box_display" id="_molongui_guest_author_box_display">
            ...
            <option value="show"    <?php selected( $guest_author_hide_box, 'show' ); disabled( MOLONGUI_AUTHORSHIP_IS_PRO, false ); ?>><?php _e( 'Show', 'molongui-authorship' ); ?></option>
            <option value="hide"    <?php selected( $guest_author_hide_box, 'hide' ); disabled( MOLONGUI_AUTHORSHIP_IS_PRO, false ); ?>><?php _e( 'Hide', 'molongui-authorship' ); ?></option>
        </select>
    </div>
