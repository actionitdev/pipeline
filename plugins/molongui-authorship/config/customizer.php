...
(
	...
	(
		...
		(
			...
			'description'        => __( '', 'molongui-authorship' ),
			'display'            => false,
			'priority'           => '',
			'type'               => '',
			'capability'         => 'manage_options',
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[scheme]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[layout]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[position]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[order]',
					'display' => false,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						'description'     => __( 'Author box is added to post content in the configured position. Nonetheless, other plugins may also add their stuff, making the author box appear above/below it. Reduce the number below until the box goes up there where you like or increase it to make it go down.', 'molongui-authorship' ),
						'priority'        => 10,
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_margin]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_width]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_border]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						(
							...
							(
								...
								'premium' => !MOLONGUI_AUTHORSHIP_IS_PRO,
							),
							'verticals' => array
							(
							...
							(
								...
								'label'   => __( 'Left', 'molongui-authorship' ),
								'premium' => !MOLONGUI_AUTHORSHIP_IS_PRO,
							),
							'top' => array
							(
							...
							(
								...
								'label'   => __( 'Right', 'molongui-authorship' ),
								'premium' => !MOLONGUI_AUTHORSHIP_IS_PRO,
							),
							'bottom' => array
							(
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_border_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_border_width]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_border_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_background]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[box_shadow]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[show_headline]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[headline]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[headline_text_size]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[headline_text_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[headline_text_case]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[headline_text_align]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						(
							...
							(
								...
								'label'   => __( 'Center', 'molongui-authorship' ),
								'premium' => false,
							),
							'right' => array
							(
							...
							(
								...
								'label'   => __( 'Justify', 'molongui-authorship' ),
								'premium' => false,
							),
						),
						'input_attrs'     => array(),
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[headline_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[tabs_position]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[tabs_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[tabs_active_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[tabs_background]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[tabs_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[about_the_author]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[related_posts]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[profile_layout]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[profile_valign]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[profile_title]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bottom_background_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bottom_border_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bottom_border_width]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bottom_border_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[show_avatar]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						(
							...
							(
                                'display' => true,
								'label'   => __( 'Show', 'molongui-authorship' ),
								'premium' => false,
							),
							'0' => array
							(
                                'display' => true,
								'label'   => __( 'Hide', 'molongui-authorship' ),
								'premium' => false,
							),
						),
						'input_attrs'     => array
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_src]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
						'capability'           => 'manage_options',
						'default'              => molongui_authorship_is_feature_enabled( 'avatar' ) ? 'local' : 'gravatar',
						'transport'            => 'refresh',
						'validate_callback'    => '',
						'sanitize_callback'    => '',
						'sanitize_js_callback' => '',
					...
					(
						...
						(
							'local' => array
							(
							    'display' => true,//molongui_authorship_is_feature_enabled( 'avatar' ),
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_local_fallback]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_default_gravatar]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_width]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_height]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_border_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_border_width]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_border_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						'input_attrs'     => array
						(
							'premium' => false,//!MOLONGUI_AUTHORSHIP_IS_PRO,
						),
						'allow_addition'  => false,
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_bg_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[avatar_link_to_archive]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
		...
		(
			...
			(
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_text_size]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_text_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_text_case]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_text_align]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_link_to_archive]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[name_inherited_underline]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[show_meta]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_text_size]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_text_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_text_case]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_text_align]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[at]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[web]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[more_posts]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[bio]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[meta_separator]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						...
						(
							...
							(
								'label'    => __( '||' ),
								'disabled' => !MOLONGUI_AUTHORSHIP_IS_PRO,
								'premium'  => !MOLONGUI_AUTHORSHIP_IS_PRO,
							),
							'/' => array
							(
		...
		(
			...
			(
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_text_size]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_line_height]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_text_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_text_case]',
					'display' => false,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_text_align]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
                ...
                array
                (
                    'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[bio_field]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[show_icons]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[icons_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[icons_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[icons_size]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[related_layout]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'strings[related_title]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
					...
					(
						'label'           => __( 'Section label', 'molongui-authorship' ),
						'description'     => __( 'If you have the Pro version of the plugin, you can use {author_name} (curly brackets included) in your string. It will be replaced by the actual author name on the frontend.', 'molongui-authorship' ),
						'priority'        => 10,
						'class'           => 'WP_Customize_Control',
						'type'            => 'text',
						'choices'         => array(),
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[no_related_posts]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
		...
		(
			...
			(
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[related_text_size]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[related_text_style]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[related_text_case]',
                    'display' => true,
                    'setting' => array
                    (
                        'type'                 => 'option',
				...
				array
				(
					'id'      => MOLONGUI_AUTHORSHIP_DB_PREFIX.'box[related_text_color]',
					'display' => true,
					'setting' => array
					(
						'type'                 => 'option',
