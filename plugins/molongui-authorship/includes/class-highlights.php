...
class Highlights
{
	public function highlights_plugin()
	{
        ...
        <ul>
            ...
            <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Pro only', 'molongui-authorship' ); ?></span><?php printf( __( "%sShortcodes%s. Display author boxes on your sidebar or anywhere you like, a list of authors and contributors of your blog and a list of posts by author.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
		    <?php if ( !MOLONGUI_AUTHORSHIP_IS_PRO ) : ?>
		...
		(
			...
			(
				'customizer' => array
				(
					'href'   => molongui_authorship_get_customizer(),
					'target' => '_self',
				...
				'settings' => array
				(
					'href'   => admin_url( $config['menu']['slug'] . MOLONGUI_AUTHORSHIP_NAME ),
					'target' => '_self',
					'class'  => '',
					'icon'   => '',
				...
				'documentation' => array
				(
					'href'   => MOLONGUI_AUTHORSHIP_FW_URL_WEB.'docs',
					'target' => '_blank',
					'class'  => '',
					'icon'   => '',
				...
				(
					...
					'hidden' => MOLONGUI_AUTHORSHIP_IS_PRO,
				),
			),
		);
		return $content;
	...
	public function highlights_release_210()
	{
		...
		?>
			...
			<ul>
                ...
                <?php endif; ?>
                <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php printf( __( "Added setting to %sdisable user archive pages%s and redirect pages to any given destination.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
                <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php printf( __( "Added setting to %schange author archives template and the author base%s.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
                <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php _e( "Added more customization settings: text style, border style...", 'molongui-authorship' ); ?></li>
            </ul>
		...
		(
			...
			(
				...
				'changelog' => array
				(
					'href'   => MOLONGUI_AUTHORSHIP_FW_URL_WEB . 'molongui-authorship-changelog/',
					'target' => '_blank',
					'class'  => '',
					'icon'   => '',
	...
	public function highlights_release_300()
	{
        ...
        <ul>
            ...
            <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php printf( __( "Added 7 %snew profile templates%s.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
            <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php printf( __( "Added a %sthird new template%s to display related entries into the author box.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
            <li class="molongui-notice-icon-check <?php echo ( !MOLONGUI_AUTHORSHIP_IS_PRO ? 'molongui-notice-only-premium' : '' ); ?>"><span><?php _e( 'Premium only', 'molongui-authorship' ); ?></span><?php printf( __( "New %s'Contributors' page%s featuring a list of all authors in your site.", 'molongui-authorship' ), '<strong>', '</strong>' ); ?></li>
        </ul>
    ...
    public function highlights_release_400()
    {
    }
