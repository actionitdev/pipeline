...
use Molongui\Authorship\Fw\Includes\Libraries\WP_Background_Process;
    ...
    protected function task( $item )
    {
        ...
        switch ( $item['author']['type'] )
        {
            case 'user':
                ...
                if ( \get_user_meta( $item['author']['id'], $meta_key, true ) ) \update_user_meta( $item['author']['id'], $meta_key, $count );
                else \add_user_meta( $item['author']['id'], $meta_key, $count, true );
            ...
            case 'guest':
                ...
                if ( \get_post_meta( $item['author']['id'], $meta_key, true ) ) \update_post_meta( $item['author']['id'], $meta_key, $count );
                else \add_post_meta( $item['author']['id'], $meta_key, $count, true );
