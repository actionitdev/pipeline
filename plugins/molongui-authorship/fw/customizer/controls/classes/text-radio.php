                    ...
                    <?php if ( !empty( $this->label ) ) : ?>
                        <span class="customize-control-title">
                            ...
                            <?php if ( !$is_disabled and $is_premium ) : ?>
                                <img class="molongui-premium-setting-label" src="<?php echo plugins_url( '/', dirname( dirname( plugin_dir_path( __FILE__ ) ) ) ); ?>admin/img/lock.png" title="<?php _e( 'Premium setting. Only preview available.', 'molongui-authorship' ); ?>" />
                            <?php endif; ?>
                        </span>
                    <?php endif; ?>
