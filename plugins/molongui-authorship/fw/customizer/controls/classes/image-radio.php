            ...
            <div class="molongui-image-radio-button-control">
				...
				<?php foreach ( $this->choices as $key => $value ) : ?>
                    <label class="radio-button-label">
			            ...
			            <?php if ( $value['premium'] ) : ?><img class="molongui-premium-setting-label" src="<?php echo plugins_url( '/', dirname( dirname( plugin_dir_path( __FILE__ ) ) ) ); ?>admin/img/lock.png" title="<?php _e( 'Premium option. Only preview available.', 'molongui-authorship' ); ?>" /><?php endif; ?>
                    </label>
				<?php endforeach; ?>
