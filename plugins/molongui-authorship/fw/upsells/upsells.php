...
(
    ...
    (
        ...
        'img'      => 'https://ps.w.org/molongui-authorship/assets/banner-1544x500.png?rev=2121645',//$this->plugin->url.'/fw/upsells/img/molongui_authorship.png',
    ...
    (
        ...
        'demo'     => 'https://demos.molongui.com/test-drive-molongui-authorship-premium/',
    ),
    'molongui-bump-offer/molongui-bump-offer.php' => array
    (
        'id'       => 'molongui-bump-offer',
        'name'     => 'Molongui 1-Click Upsell For WooCommerce',
        'pro'      => false,
        'link'     => 'https://wordpress.org/plugins/molongui-bump-offer/',
        'img'      => 'https://ps.w.org/molongui-bump-offer/assets/banner-1544x500.png?rev=2006241',//$this->plugin->url.'/fw/upsells/img/molongui_bump_offer.png',
        ...
        'features' => array
        (
            __( "Display a 1-Click Upsell Offer on the Checkout page", 'molongui-authorship' ),
    ...
    (
        ...
        'name'     => 'Molongui 1-Click Upsell Pro',
        'pro'      => true,
        'link'     => 'https://www.molongui.com/one-click-upsell-for-woocommerce/',
        'img'      => 'https://ps.w.org/molongui-bump-offer/assets/banner-1544x500.png?rev=2006241',//$this->plugin->url.'/fw/upsells/img/molongui_bump_offer.png',
        'desc'     => __( "Go Pro and enjoy additional Premium features", 'molongui-authorship' ),
        'features' => array
        (
            sprintf( __( "%sUnlimited Upsell Offers%s – Add as many as needed, display more than one on the same page.", 'molongui-authorship' ), '<strong>', '</strong>' ),
        ...
        'demo'     => 'https://demos.molongui.com/test-drive-molongui-order-bump-premium/',
    ),
);