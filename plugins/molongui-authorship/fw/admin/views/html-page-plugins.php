...
<div class="molongui-page-plugins">
    ...
    <div class="m-page-content">
        ...
        if ( empty( $upsells ) )
        {
            ...
            <a href="<?php echo molongui_get_constant( $this->plugin->id, 'URL_WEB', true ); ?>" class="button button-primary" title="Visit Molongui website" target="_blank"><?php _e( 'Visit our site', 'molongui-authorship' ); ?></a>
            <?php
        }
        else
        {
                        ...
                        <?php if ( !empty( $upsell['features'] ) ) : ?>
                            <ul class="m-list">
                                <?php foreach( $upsell['features'] as $feature ) : ?>
                                    <li><i class="molongui-icon-ok"></i> <?php echo $feature; ?></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
                    </div>
