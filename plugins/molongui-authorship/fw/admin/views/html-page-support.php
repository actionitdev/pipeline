...
<div class="molongui-page-support">
    ...
    (
        'logo'   => false,
        'link'   => molongui_get_constant( $this->plugin->id, 'URL_WEB', true ),
        'button' => null,
    );
    ...
    <div class="m-page-content">
        ...
        <div class="m-card m-card-header">
            ...
            <div class="m-card-header__actions">
                <a href="<?php echo molongui_get_constant( $this->plugin->id, 'URL_DOCS', true ); ?>" target="_blank" type="button" class="m-button is-compact is-primary same-width"><?php _e( "Read Docs", 'molongui-authorship' ); ?></a>
            </div>
        </div>
        <div class="m-card">
            <div>
        ...
        <div class="m-card m-card-header">
            ...
            <div class="m-card-header__actions">
                <a href="<?php echo molongui_get_constant( $this->plugin->id, 'URL_SUPPORT', true ); ?>" target="_blank" type="button" class="m-button is-compact same-width"><?php _e( "Get Support", 'molongui-authorship' ); ?></a>
            </div>
        </div>
        <div class="m-card">
            <div>
            ...
            <div>
                <form id="molongui-help-ticket-form">
                    ...
                    <p>
                        ...
                        <input type="text" name="your-subject" required placeholder="<?php _e( 'A subject here', 'molongui-authorship' ); ?>">
                    </p>
                    <p>
                        ...
                        <select name="plugin" required>
                            ...
                            <option value="Molongui 1-Click Upsell for WooCommerce">Molongui 1-Click Upsell for WooCommerce</option>
                            <option value="Molongui 1-Click Upsell Pro">Molongui 1-Click Upsell Pro</option>
                        </select>
                    </p>
                    <p>
                    ...
                    <p><input type="checkbox" id="molongui-accept-tos" name="molongui-accept-tos" value="1"><?php printf( __( "I have read and accept the %sprivacy policy%s.", 'molongui-authorship' ), '<a href="'.molongui_get_constant( $this->plugin->id, 'URL_WEB', true ).'privacy/">', '</a>' ); ?></p>
        ...
        <div class="m-card">
            ...
            <div>
                <ul class="m-list">
                    <li><i class="molongui-icon-language"></i><?php _e( "We speak English and Spanish", 'molongui-authorship' ); ?></li>
                    <li><i class="molongui-icon-ok"></i><?php _e( "We answer Monday to Friday, from 9 AM to 6 PM (GMT)", 'molongui-authorship' ); ?></li>
                    <li><i class="molongui-icon-mail"></i><?php _e( "If offline, please leave your email address so we can get in touch with you", 'molongui-authorship' ); ?></li>
                </ul>
            </div>
        </div>
    ...
    (
        ...
        (
            ...
            (
                ...
                'prefix'  => '',
                'suffix'  => '',
                'href'    => molongui_get_constant( $this->plugin->id, 'URL_WEB', true ),
                'display' => true,
            ),
            array
            (
                ...
                'prefix'  => '',
                'suffix'  => '',
                'href'    => molongui_get_constant( $this->plugin->id, 'URL_DOCS', true ),
                'display' => true,
            ),
            array
            (
                ...
                'prefix'  => '',
                'suffix'  => '',
                'href'    => molongui_get_constant( $this->plugin->id, 'URL_DEMOS', true ),
                'display' => true,
            ),
            array
            (
                ...
                'prefix'  => '',
                'suffix'  => '',
                'href'    => molongui_get_constant( $this->plugin->id, 'URL_SUPPORT', true ),
                'display' => true,
            ),
            array
            (
